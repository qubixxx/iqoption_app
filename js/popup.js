...
function refreshUI() {
	if (connected == "true") {
		...
		if (configured == "true") {
			...
			element_status_message.innerHTML = "Listo para operar"
		} else {
			element_start.className = "list-group-item disabled"
			element_start.disabled = true
			element_pause.className = "list-group-item disabled"
			...
			element_status_message.innerHTML = "Debe configurar una estrategia comercial en la sección Configuración."
		}
		if (trade == "true") {
			element_start.className = "list-group-item disabled"
			element_start.disabled = true
			...
			element_status_message.className = "alert alert-success"
			element_status_message.innerHTML = "Comercio en curso"
		}
	} else {
		element_start.className = "list-group-item disabled"
		element_start.disabled = true
		...
		element_status_message.innerHTML = "Debes iniciar sesión en el sitio."
...
function onLoad() {
	...
	element_version.innerHTML = "Versión: " + manifest.version
	refreshUI()
}
